...
export default function Home() {
  ...
  function displayDetails() {
    ...
    let FDreturn = parseFloat(P)+parseFloat(P*R*N/100);
    ...
    document.querySelector("#ct").innerText = "₹ " + parseFloat(parseFloat(P) + parseFloat(FDreturn)).toLocaleString("en-US");
  ...
  return (
    ...
    <div className="container border border-[#7042f88b] opacity-[0.9]">
      <div className="header mt-6 md:m-0">
        <h1 style={{ color: '#6258A8' }}>FD Calculator</h1>
      ...
      <div className="sub-container">
        <div className="view">
          <div className="details ">
            ...
            <div>
              <div className="detail items-center md:items-start">
                <p style={{ color: '#9088D2'}} draggable="true" onDragStart={() => setN(1)}>Tenure(year)</p>
                <input
                  type="number"
