...
const SearchInput = ({ handleSearch }) => {
  ...
  let { searchData, setCoinSearch, setSearchData } = useContext(StockContext);
  ...
  return (
    <div className="relative w-auto " style={{ zIndex: 1 }}>
      <form
        style={{
          ...
          zIndex: "1", // This is equivalent to z-1
          ":hover": {
      ...
      >
        <Input
          ...
          className="w-full flex items-center shadow-inner hover:shadow-lg hover:scale-110 transition-all transition-ease"
          placeholder="Searching Under Construction "
          color="black"
...
const Search = () => {
  let { getSearchResult } = useContext(StockContext);
