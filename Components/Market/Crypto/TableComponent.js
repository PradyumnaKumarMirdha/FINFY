...
const TableComponent = () => {
  ...
  return (
    <>
      <div
        style={{ position: "static", zIndex: "21" }}
      ...
      >
        {cryptoData ? (
          <table className="w-full table-auto">
            ...
            <tbody>
              {cryptoData.map((data) => {
                let market_cap_change_percentage_24h =
                  data.market_cap_change_percentage_24h > 0;
                let price_change_percentage_1h_in_currency =
                  data.price_change_percentage_1h_in_currency > 0;
                let price_change_percentage_24h_in_currency =
                  data.price_change_percentage_24h_in_currency > 0;
                let price_change_percentage_7d_in_currency =
                ...
                return (
                  ...
                  >
                    <td className="py-4 flex items-center uppercase">
                      ...
                      >
                        <img
                          className="w-[1.2rem] h-[1.2rem] mx-1.5 hover:size-7 transition-all transition-ease"
                          src={data.image}
                          alt={data.name}
                        />
                      </Link>
                    ...
                    <td
                     style={{
                      color: price_change_percentage_1h_in_currency
                        ? "#25da72"
                        : "#d6436e",
                    }}
                    className={"py-4  lg:table-cell hidden"}
