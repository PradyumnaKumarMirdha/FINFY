...
import Chart from "../@modal/(..)Crypto/[Id]/Chart";
  ...
  return (
    <>
      <span
        ...
        style={{ width: `${100 - '#25da72'}%`, backgroundColor: '#d6436e', width: "50%", borderRadius: "20px 0 0 20px" }}
      >
        &nbsp;
      </span>
      <span
        className="bg-[#25da72] h-1.5 w-[50%] transition-all transition-ease"
        style={{ width: `${'#25da72'}%`, backgroundColor: '#25da72', width: "50%", borderRadius: " 0 20px 20px 0"}}
      >
        &nbsp;
      </span>
    </>
      ...
      {data ? (
        ...
        "
          ...
          `}
            ...
            <p
              variant="h3"
              className="mt-5 text-sm text-justify font-light tracking-wide line-clamp-5 hover:line-clamp-none leading-relaxed "
            >
