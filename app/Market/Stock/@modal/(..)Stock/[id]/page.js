      ...
      className="w-[90%] h-[90%] flex bg-white bg-opacity-75 rounded-lg text-black relative  lg:overflow-hidden scrollbar-thumb-gray-100s scrollbar-track-gray-200 overflow-x-hidden">
        ...
        "
              ...
              {/* <div className="flex w-full mt-4 justify-between">
                ...
                <div className="flex flex-col">
                  <span className="text-sm capitalize text-gray-100 self-end justify-end text-end" style={{alignSelf: "end"}}>
                    high 24H
                  </span>
                  <h2 className="text-base font-bold">
                    {new Intl.NumberFormat("en-IN", {
              ...
              <p
                ...
                style={{
                  ...
                  WebkitLineClamp: "5", // Equivalent to line-clamp-5
                  WebkitBoxOrient: "vertical",
                  display: "-webkit-box",
                  lineHeight: "1.5", // Equivalent to leading-relaxed
                }}
    ...
    "
          ...
          <div className="flex w-full mt-4 justify-between">
            <div className="flex flex-col">
              ...
              <Skeleton variant="rect" width={150} className="text-base font-bold" />
            </div>
            <div className="flex flex-col">
              <span className="text-sm capitalize text-gray-100">
                Headquaters
          ...
          <div className="flex flex-col mt-4">
            ...
            <Skeleton variant="rect" width={300} className="text-base font-bold" />
          </div>

          <div className="flex flex-col mt-4">
            <span className="text-sm capitalize text-gray-100">CEO</span>
            <Skeleton variant="rect" width={300} className="text-base font-bold" />
          </div>
