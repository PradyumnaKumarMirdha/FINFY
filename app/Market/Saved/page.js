...
import { SavedContext } from "../context/Crypto/SavedContext";
import { CryptoContext } from "./../context/Crypto/testCrypto";
import Filters from "../../../Components/Market/Crypto/Filters";
import Home from "../Crypto/Home"
import { Skeleton } from "@material-ui/lab";
import Pagination from "../../../Components/Market/Crypto/Pagination";
...
const SaveBtn = ({ data }) => {
  ...
  const handleClick = (e) => {
    ...
    e.stopPropagation(); // Stop the event propagation to prevent further event handling
...
const Saved = () => {
  ...
  return (
    <>
      <Home />
      <section className=" text-black w-[80%] h-full flex flex-col mt-16 mb-24 relative">
        <Filters />
        <div className="flex flex-col mt-9 border bg-white border-gray-100 rounded">
        {savedData ? (
